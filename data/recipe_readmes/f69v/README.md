# Voynich Speculative Herbal Ferment Recipe — f69v

IMPORTANT: this is NOT a real or validated translation of the Voynich Manuscript. It is a speculative/procedural model that interprets EVA using a user-defined grammar to generate experimental recipes using safe, known edible substitutes.

This file is generated automatically from IVTFF/EVA transliteration plus a user-defined procedural grammar.

![f69v](../../images/q10/f069v_crd.jpg)
...
- compound_counts: {'yeast fermentation': 47, 'main herb': 36, 'sugars': 40, 'mix/transfer': 98, 'heat': 28, 'secondary herb': 2, 'complex herbal compound': 1, 'liquid base': 2}
- dose_level: 3
...
- otaza: apply heat/cooking → mix / transfer → duration level 1 → state: fermentation start
...
- o: mix / transfer
- eykeody: add fermentable sugars → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
...
Direct Gloss (Procedural, Not a Real Translation):
- ykac: add fermentable sugars → duration level 1 → state: fermentation start
- chol: add main plant (safe substitute) → mix / transfer
...
- s: [unparsed]
- oaram: mix / transfer → duration level 1 → state: fermentation start
...
- airchy: add main plant (safe substitute) → duration level 1 → state: fermentation start
...
Direct Gloss (Procedural, Not a Real Translation):
- doair: mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- chda: add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- ytyd: apply heat/cooking → start fermentation (yeast)
- a: duration level 1 → state: fermentation start
...
Direct Gloss (Procedural, Not a Real Translation):
- ykeydy: add fermentable sugars → start fermentation (yeast) → duration level 1 → state: active extraction
...
Direct Gloss (Procedural, Not a Real Translation):
- sarydy: start fermentation (yeast) → duration level 1 → state: fermentation start
...
Direct Gloss (Procedural, Not a Real Translation):
- okodchy: add fermentable sugars → add main plant (safe substitute) → mix / transfer → start fermentation (yeast)
