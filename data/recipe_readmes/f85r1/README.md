# Voynich Speculative Herbal Ferment Recipe — f85r1
...
- compound_counts: {'yeast fermentation': 210, 'secondary herb': 53, 'mix/transfer': 170, 'heat': 65, 'main herb': 100, 'aroma modifier': 8, 'liquid base': 43, 'complex herbal compound': 13, 'sugars': 70, 'general base': 1}
- dose_level: 3
...
- pdsheody: add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
- shdol: add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast)
...
- soeeedy: mix / transfer → start fermentation (yeast) → duration level 3 → state: active extraction
- dchefoey: add main plant (safe substitute) → add aroma modifier → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
...
- sodair: mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
- shey: add secondary herb (safe substitute) → duration level 1 → state: active extraction
...
- qocthdy: prepare liquid base → start fermentation (yeast) → add complex herbal compound (safe blend)
...
- okshd: add fermentable sugars → add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast)
...
- ykdair: add fermentable sugars → start fermentation (yeast) → duration level 1 → state: fermentation start
...
Direct Gloss (Procedural, Not a Real Translation):
- odeedaiin: mix / transfer → start fermentation (yeast) → duration level 2 → state: active extraction → long fermentation / aging phase
...
- doltshdy: apply heat/cooking → add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast)
...
- tdam: apply heat/cooking → start fermentation (yeast) → duration level 1 → state: fermentation start
...
Direct Gloss (Procedural, Not a Real Translation):
- roraiin: mix / transfer → duration level 1 → state: fermentation start → long fermentation / aging phase
- shey: add secondary herb (safe substitute) → duration level 1 → state: active extraction
...
- ldo: mix / transfer → start fermentation (yeast)
...
Direct Gloss (Procedural, Not a Real Translation):
- tsheed: apply heat/cooking → add secondary herb (safe substitute) → start fermentation (yeast) → duration level 2 → state: active extraction
...
- chofchdy: add main plant (safe substitute) → add aroma modifier → mix / transfer → start fermentation (yeast)
- qotdc: prepare liquid base → apply heat/cooking → start fermentation (yeast)
- y: [unparsed]
...
- aiin: duration level 1 → state: fermentation start → long fermentation / aging phase
- opakam: add fermentable sugars → mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
...
Direct Gloss (Procedural, Not a Real Translation):
- tdain: apply heat/cooking → start fermentation (yeast) → duration level 1 → state: fermentation start
...
Direct Gloss (Procedural, Not a Real Translation):
- rsheodar: add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
...
- ykeeeody: add fermentable sugars → mix / transfer → start fermentation (yeast) → duration level 3 → state: active extraction
...
Direct Gloss (Procedural, Not a Real Translation):
- daror: mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
- sheedy: add secondary herb (safe substitute) → start fermentation (yeast) → duration level 2 → state: active extraction
...
Direct Gloss (Procedural, Not a Real Translation):
- polky: add fermentable sugars → mix / transfer → start fermentation (yeast)
- shey: add secondary herb (safe substitute) → duration level 1 → state: active extraction
- olkedaiin: add fermentable sugars → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction → long fermentation / aging phase
...
- dair: start fermentation (yeast) → duration level 1 → state: fermentation start
- shcphhy: add secondary herb (safe substitute) → add complex herbal compound (safe blend)
...
- aiinsham: add secondary herb (safe substitute) → duration level 1 → state: fermentation start → long fermentation / aging phase
...
- qokedy: prepare liquid base → add fermentable sugars → start fermentation (yeast) → duration level 1 → state: active extraction
- qodaiin: prepare liquid base → start fermentation (yeast) → duration level 1 → state: fermentation start → long fermentation / aging phase
- chctahy: apply heat/cooking → add main plant (safe substitute) → duration level 1 → state: fermentation start
...
- shdaldy: add secondary herb (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- shofshedy: add secondary herb (safe substitute) → add aroma modifier → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
...
Direct Gloss (Procedural, Not a Real Translation):
- schedaiir: add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: active extraction
- oteody: apply heat/cooking → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
...
- or: mix / transfer
- shshdar: add secondary herb (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start
...
Direct Gloss (Procedural, Not a Real Translation):
- ychedy: add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: active extraction
- shetshdy: apply heat/cooking → add secondary herb (safe substitute) → start fermentation (yeast) → duration level 1 → state: active extraction
...
- saiin: duration level 1 → state: fermentation start → long fermentation / aging phase
- ol: mix / transfer
- karar: add fermentable sugars → duration level 1 → state: fermentation start
- odeeeg: mix / transfer → start fermentation (yeast) → duration level 3 → state: active extraction
...
Direct Gloss (Procedural, Not a Real Translation):
- kchedar: add fermentable sugars → add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: active extraction
...
Direct Gloss (Procedural, Not a Real Translation):
- dorchdy: add main plant (safe substitute) → mix / transfer → start fermentation (yeast)
- o: mix / transfer
- r: [unparsed]
- s: [unparsed]
- aiin: duration level 1 → state: fermentation start → long fermentation / aging phase
- okeder: add fermentable sugars → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
...
- otchdy: apply heat/cooking → add main plant (safe substitute) → mix / transfer → start fermentation (yeast)
- otalom: apply heat/cooking → mix / transfer → duration level 1 → state: fermentation start
...
- shdar: add secondary herb (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start
- ypchdar: add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start
- dar: start fermentation (yeast) → duration level 1 → state: fermentation start
- ypchdy: add main plant (safe substitute) → start fermentation (yeast)
...
- dchdal: add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start
- chol: add main plant (safe substitute) → mix / transfer
...
- or: mix / transfer
- eeodaiin: mix / transfer → start fermentation (yeast) → duration level 2 → state: active extraction → long fermentation / aging phase
- or: mix / transfer
...
Direct Gloss (Procedural, Not a Real Translation):
- raraiiin: duration level 1 → state: fermentation start → medium fermentation phase
- shey: add secondary herb (safe substitute) → duration level 1 → state: active extraction
...
- olpchdy: add main plant (safe substitute) → mix / transfer → start fermentation (yeast)
