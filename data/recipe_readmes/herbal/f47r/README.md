...
- chair: add main plant (safe substitute) → duration level 1 → state: phase transition/start
- oly: mix / transfer
...
- ctham: add complex herbal compound (safe blend) → duration level 1 → state: phase transition/start
