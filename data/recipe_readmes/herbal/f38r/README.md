...
- chodys: add main plant (safe substitute) → mix / transfer → add starter / activate
...
- ckholdy: mix / transfer → add starter / activate → add complex herbal compound (safe blend)
