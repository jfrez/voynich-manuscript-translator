# Voynich Speculative Procedural Protocol — f10r

IMPORTANT: this is NOT a real or validated translation of the Voynich Manuscript. It is a speculative/procedural model that interprets EVA using a user-defined grammar to generate experimental recipes using safe, known edible substitutes.

This file is generated automatically from IVTFF/EVA transliteration plus a user-defined procedural grammar.

![f10r](../../../images/q02/f010r_crd.jpg)
...
- chopchal: tokens: ch o p ch a l → connectors: l → vowel_run: a (level 1; class a)
- ypch: tokens: p ch
...
- chtchor: tokens: ch t ch o r → connectors: r
- do: tokens: p o
...
- qoctholy: tokens: qo cth o l → connectors: l
- dy: tokens: p
- chy: tokens: ch
...
Direct Gloss (Procedural, Not a Real Translation):
- oykchor: tokens: o k ch o r → connectors: r
- shor: tokens: sh o r → connectors: r
- chor: tokens: ch o r → connectors: r
- chy: tokens: ch
...
Direct Gloss (Procedural, Not a Real Translation):
- otchoshor: tokens: o t ch o sh o r → connectors: r
- qoty: tokens: qo t
- qotor: tokens: qo t o r → connectors: r (lexicon-context: `qotor` → `corto`; short)
- cthyd: tokens: cth p
