...
- pdair: tokens: p p a i r → connectors: r → vowel_run: a (level 1; class a)
- chdy: tokens: ch p
- fdykain: tokens: f p k a i n → connectors: n → vowel_run: a (level 1; class a)
- or: tokens: o r → connectors: r
- air: tokens: a i r → connectors: r → vowel_run: a (level 1; class a)
- sheykaiiin: tokens: sh e k a iii n → connectors: n → vowel_run: e (level 1; class e) → suffix: iin
- ofchy: tokens: o f ch
- kar: tokens: k a r → connectors: r → vowel_run: a (level 1; class a)
- or: tokens: o r → connectors: r
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
- dolky: tokens: p o l k → connectors: l
- o: tokens: o
- sh: tokens: sh
...
- okaii: tokens: o k a ii → vowel_run: a (level 1; class a)
- fchody: tokens: f ch o p
...
Direct Gloss (Procedural, Not a Real Translation):
- ytedykor: tokens: t e p k o r → connectors: r → vowel_run: e (level 1; class e)
- or: tokens: o r → connectors: r
...
- qoykam: tokens: qo k a m → connectors: m → vowel_run: a (level 1; class a)
- cho: tokens: ch o
- ckhcfhhy: tokens: ckh cfh h → unmodeled_tokens: h
- or: tokens: o r → connectors: r
...
Direct Gloss (Procedural, Not a Real Translation):
- pardy: tokens: p a r p → connectors: r → vowel_run: a (level 1; class a)
...
Direct Gloss (Procedural, Not a Real Translation):
- oekar: tokens: o e k a r → connectors: r → vowel_run: e (level 1; class e)
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
...
- ar: tokens: a r → connectors: r → vowel_run: a (level 1; class a)
- sheedy: tokens: sh ee p → vowel_run: ee (level 2; class e)
- olchef: tokens: o l ch e f → connectors: l → vowel_run: e (level 1; class e)
