...
- qopchedal: tokens: qo p ch e p a l → connectors: l → vowel_run: e (level 1; class e)
...
- olkeody: tokens: o l k e o p → connectors: l → vowel_run: e (level 1; class e)
...
- y: [unparsed]
- o: tokens: o
- ykaro: tokens: k a r o → connectors: r → vowel_run: a (level 1; class a)
...
- o: tokens: o
- xockhhy: tokens: x o ckh h → unmodeled_tokens: h
...
- chykaidy: tokens: ch k a i p → vowel_run: a (level 1; class a)
