# Voynich Speculative Herbal Ferment Recipe — f2r

IMPORTANT: this is NOT a real or validated translation of the Voynich Manuscript. It is a speculative/procedural model that interprets EVA using a user-defined grammar to generate experimental recipes using safe, known edible substitutes.

This file is generated automatically from IVTFF/EVA transliteration plus a user-defined procedural grammar.

![f2r](../../images/q01/f002r_crd.jpg)

## Page / Folio
- currier: A
- folio: f2r
- page_number: 3
- plant_candidates: ['Cyanus segelis coeruleus', 'centaurea']
- plant_category_confidence: 0.95
- plant_category_guess: flower
- plant_category_matches: ['centaurea', 'cyanus', 'kornblume']
- plant_id: Cyanus segelis coeruleus (Kornblume), centaurea (cf. Holm)
- section: herbal
...
- textual_evidence_terms: ['centaurea', 'cyanus', 'kornblume']
...
- compound_counts: {'sugars': 16, 'yeast fermentation': 35, 'main herb': 27, 'mix/transfer': 46, 'heat': 9, 'complex herbal compound': 10, 'secondary herb': 14, 'liquid base': 4, 'aroma modifier': 1}
- dose_level: 2
...
- kydainy: add fermentable sugars → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- ypchaiin: add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start → long fermentation / aging phase
...
Direct Gloss (Procedural, Not a Real Translation):
- dorchory: add main plant (safe substitute) → mix / transfer → start fermentation (yeast)
...
Direct Gloss (Procedural, Not a Real Translation):
- c: [unparsed]
- oaiidy: mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
- chtod: apply heat/cooking → add main plant (safe substitute) → mix / transfer → start fermentation (yeast)
...
- ytchaiin: apply heat/cooking → add main plant (safe substitute) → duration level 1 → state: fermentation start → long fermentation / aging phase
- dan: start fermentation (yeast) → duration level 1 → state: fermentation start
...
- d: start fermentation (yeast)
- dkol: add fermentable sugars → mix / transfer → start fermentation (yeast)
- sor: mix / transfer
...
Direct Gloss (Procedural, Not a Real Translation):
- kydain: add fermentable sugars → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- fodan: add aroma modifier → mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- daiildy: start fermentation (yeast) → duration level 1 → state: fermentation start
...
- ykody: add fermentable sugars → mix / transfer → start fermentation (yeast)
- so: mix / transfer
- chol: add main plant (safe substitute) → mix / transfer
- yky: add fermentable sugars
- dain: start fermentation (yeast) → duration level 1 → state: fermentation start
- daiisol: mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
...
Direct Gloss (Procedural, Not a Real Translation):
- ytoail: apply heat/cooking → mix / transfer → duration level 1 → state: fermentation start
