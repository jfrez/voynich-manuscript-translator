# Voynich Speculative Herbal Ferment Recipe — f13r

IMPORTANT: this is NOT a real or validated translation of the Voynich Manuscript. It is a speculative/procedural model that interprets EVA using a user-defined grammar to generate experimental recipes using safe, known edible substitutes.

This file is generated automatically from IVTFF/EVA transliteration plus a user-defined procedural grammar.

![f13r](../../images/q02/f013r_crd.jpg)

## Page / Folio
- currier: A
- folio: f13r
- page_number: 23
- plant_candidates: ['Tussilago petronitas', 'colto foot']
- plant_category_confidence: 0.25
- plant_category_guess: leaf
- plant_category_matches: ['section=herbal_default']
- plant_id: Tussilago petronitas, colto foot (all sp?)
- section: herbal
...
Direct Gloss (Procedural, Not a Real Translation):
- shorodo: add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast)
- shy: add secondary herb (safe substitute)
...
- chol: add main plant (safe substitute) → mix / transfer
- dy: start fermentation (yeast)
- qokhy: prepare liquid base → add fermentable sugars
- d: start fermentation (yeast)
...
Direct Gloss (Procedural, Not a Real Translation):
- shochy: add main plant (safe substitute) → add secondary herb (safe substitute) → mix / transfer
...
- kchky: add fermentable sugars → add main plant (safe substitute)
- s: [unparsed]
...
Direct Gloss (Procedural, Not a Real Translation):
- sotchy: apply heat/cooking → add main plant (safe substitute) → mix / transfer
- kchy: add fermentable sugars → add main plant (safe substitute)
- okorory: add fermentable sugars → mix / transfer
