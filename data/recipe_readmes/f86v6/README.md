# Voynich Speculative Herbal Ferment Recipe — f86v6
...
- compound_counts: {'yeast fermentation': 173, 'main herb': 100, 'mix/transfer': 223, 'aroma modifier': 7, 'heat': 89, 'liquid base': 88, 'sugars': 141, 'secondary herb': 46, 'general base': 3, 'complex herbal compound': 16}
- dose_level: 3
...
- pcheypchdar: add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: active extraction
...
- otedalol: apply heat/cooking → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
- orairody: mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
- qotchdaiin: prepare liquid base → apply heat/cooking → add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start → long fermentation / aging phase
...
- qopchd: prepare liquid base → add main plant (safe substitute) → start fermentation (yeast)
...
- lray: duration level 1 → state: fermentation start
...
- aiin: duration level 1 → state: fermentation start → long fermentation / aging phase
- olkeedy: add fermentable sugars → mix / transfer → start fermentation (yeast) → duration level 2 → state: active extraction
- shdal: add secondary herb (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- l: [unparsed]
- karchees: add fermentable sugars → add main plant (safe substitute) → duration level 1 → state: fermentation start
...
- taiky: add fermentable sugars → apply heat/cooking → duration level 1 → state: fermentation start
...
- chedy: add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: active extraction
- ar: duration level 1 → state: fermentation start
- sheeeb: add secondary herb (safe substitute) → duration level 3 → state: active extraction
...
- y: [unparsed]
- lchedor: add main plant (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
- or: mix / transfer
- aiin: duration level 1 → state: fermentation start → long fermentation / aging phase
- ol: mix / transfer
- or: mix / transfer
...
- s: [unparsed]
- ar: duration level 1 → state: fermentation start
- archey: add main plant (safe substitute) → duration level 1 → state: fermentation start
...
- ldaly: start fermentation (yeast) → duration level 1 → state: fermentation start
- chdal: add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- ltchedy: apply heat/cooking → add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: active extraction
...
- ykaiin: add fermentable sugars → duration level 1 → state: fermentation start → long fermentation / aging phase
- soldam: mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
- sheol: add secondary herb (safe substitute) → mix / transfer → duration level 1 → state: active extraction
...
- or: mix / transfer
- cheeaiin: add main plant (safe substitute) → duration level 2 → state: active extraction → long fermentation / aging phase
...
- lchdol: add main plant (safe substitute) → mix / transfer → start fermentation (yeast)
- or: mix / transfer
- chcphar: add main plant (safe substitute) → add complex herbal compound (safe blend) → duration level 1 → state: fermentation start
- ar: duration level 1 → state: fermentation start
...
- qokal: prepare liquid base → add fermentable sugars → duration level 1 → state: fermentation start
- otar: apply heat/cooking → mix / transfer → duration level 1 → state: fermentation start
- ykairolky: add fermentable sugars → mix / transfer → duration level 1 → state: fermentation start
...
- yfchdy: add main plant (safe substitute) → add aroma modifier → start fermentation (yeast)
- cpholkaiin: add fermentable sugars → mix / transfer → add complex herbal compound (safe blend) → duration level 1 → state: fermentation start → long fermentation / aging phase
...
- aroiiin: mix / transfer → duration level 1 → state: fermentation start → medium fermentation phase
- opchedy: add main plant (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
- opoly: mix / transfer → start fermentation (yeast)
...
- shoifhy: add secondary herb (safe substitute) → add aroma modifier → mix / transfer → duration level 1 → state: cooling/rest
...
- qotardam: prepare liquid base → apply heat/cooking → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- sheopchey: add main plant (safe substitute) → add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
- pchecfhey: add main plant (safe substitute) → start fermentation (yeast) → add complex herbal compound (safe blend) → duration level 1 → state: active extraction
- or: mix / transfer
- aiiin: duration level 1 → state: fermentation start → medium fermentation phase
- qokaiin: prepare liquid base → add fermentable sugars → duration level 1 → state: fermentation start → long fermentation / aging phase
...
Direct Gloss (Procedural, Not a Real Translation):
- pdaiiiy: start fermentation (yeast) → duration level 1 → state: fermentation start
...
- olkshed: add fermentable sugars → add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
- qofod: prepare liquid base → add aroma modifier → mix / transfer → start fermentation (yeast)
...
- tar: apply heat/cooking → duration level 1 → state: fermentation start
- otyteeodaiin: apply heat/cooking → mix / transfer → start fermentation (yeast) → duration level 2 → state: active extraction → long fermentation / aging phase
...
- tairoar: apply heat/cooking → mix / transfer → duration level 1 → state: fermentation start
- qotar: prepare liquid base → apply heat/cooking → duration level 1 → state: fermentation start
- taikhy: add fermentable sugars → apply heat/cooking → duration level 1 → state: fermentation start
- d: start fermentation (yeast)
- amom: mix / transfer → duration level 1 → state: fermentation start
...
- qokaiin: prepare liquid base → add fermentable sugars → duration level 1 → state: fermentation start → long fermentation / aging phase
- araram: duration level 1 → state: fermentation start
...
- olteedydar: apply heat/cooking → mix / transfer → start fermentation (yeast) → duration level 2 → state: active extraction
- otar: apply heat/cooking → mix / transfer → duration level 1 → state: fermentation start
...
Direct Gloss (Procedural, Not a Real Translation):
- alshdr: add secondary herb (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start
- lkar: add fermentable sugars → duration level 1 → state: fermentation start
- dal: start fermentation (yeast) → duration level 1 → state: fermentation start
- kshd: add fermentable sugars → add secondary herb (safe substitute) → start fermentation (yeast)
...
- olkeey: add fermentable sugars → mix / transfer → duration level 2 → state: active extraction
- qokchdy: prepare liquid base → add fermentable sugars → add main plant (safe substitute) → start fermentation (yeast)
- ramshy: add secondary herb (safe substitute) → duration level 1 → state: fermentation start
...
- dytshy: apply heat/cooking → add secondary herb (safe substitute) → start fermentation (yeast)
- dy: start fermentation (yeast)
...
- tshed: apply heat/cooking → add secondary herb (safe substitute) → start fermentation (yeast) → duration level 1 → state: active extraction
...
- paroiin: mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start → medium fermentation phase
...
- qopydaiin: prepare liquid base → start fermentation (yeast) → duration level 1 → state: fermentation start → long fermentation / aging phase
- qopary: prepare liquid base → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- ldaiiin: start fermentation (yeast) → duration level 1 → state: fermentation start → medium fermentation phase
- or: mix / transfer
- oro: mix / transfer
- ol: mix / transfer
...
Direct Gloss (Procedural, Not a Real Translation):
- lshar: add secondary herb (safe substitute) → duration level 1 → state: fermentation start
- o: mix / transfer
- y: [unparsed]
...
Direct Gloss (Procedural, Not a Real Translation):
- poiin: mix / transfer → start fermentation (yeast) → duration level 2 → state: cooling/rest → medium fermentation phase
- otal: apply heat/cooking → mix / transfer → duration level 1 → state: fermentation start
...
- lkaiin: add fermentable sugars → duration level 1 → state: fermentation start → long fermentation / aging phase
- oltam: apply heat/cooking → mix / transfer → duration level 1 → state: fermentation start
...
- otar: apply heat/cooking → mix / transfer → duration level 1 → state: fermentation start
- shcthdy: add secondary herb (safe substitute) → start fermentation (yeast) → add complex herbal compound (safe blend)
- qokol: prepare liquid base → add fermentable sugars → mix / transfer
...
- qotal: prepare liquid base → apply heat/cooking → duration level 1 → state: fermentation start
- lkalol: add fermentable sugars → mix / transfer → duration level 1 → state: fermentation start
- sheol: add secondary herb (safe substitute) → mix / transfer → duration level 1 → state: active extraction
- qotaiin: prepare liquid base → apply heat/cooking → duration level 1 → state: fermentation start → long fermentation / aging phase
...
- qokshey: prepare liquid base → add fermentable sugars → add secondary herb (safe substitute) → duration level 1 → state: active extraction
- ar: duration level 1 → state: fermentation start
- otalky: add fermentable sugars → apply heat/cooking → mix / transfer → duration level 1 → state: fermentation start
- chear: add main plant (safe substitute) → duration level 1 → state: active extraction
