...
- daiindy: tokens: p aiin p → vowel_run: a (level 1; class a) → suffix: aiin
...
- r: tokens: r → connectors: r
- s: tokens: s → connectors: s
- orarydaiin: tokens: o r a r p aiin → connectors: r r → vowel_run: a (level 1; class a) → suffix: aiin
