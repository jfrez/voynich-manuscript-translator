...
- kcholchdar: tokens: k ch o l ch p a r → connectors: l r → vowel_run: a (level 1; class a)
- shar: tokens: sh a r → connectors: r → vowel_run: a (level 1; class a)
- aiip: tokens: a ii p → vowel_run: a (level 1; class a)
- chepchedy: tokens: ch e p ch e p → vowel_run: e (level 1; class e)
- chetalshy: tokens: ch e t a l sh → connectors: l → vowel_run: e (level 1; class e)
...
- okeey: tokens: o k ee → vowel_run: ee (level 2; class e)
- qaal: tokens: q a a l → connectors: l → vowel_run: aa (level 2; class a)
...
- oteeam: tokens: o t ee a m → connectors: m → vowel_run: ee (level 2; class e)
...
- qokeear: tokens: qo k ee a r → connectors: r → vowel_run: ee (level 2; class e)
- cheokedy: tokens: ch e o k e p → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- saiin: tokens: s aiin → connectors: s → vowel_run: a (level 1; class a) → suffix: aiin (lexicon-context: `saiin` → `asini`; [n/a])
- sheekshy: tokens: sh ee k sh → vowel_run: ee (level 2; class e)
- ol: tokens: o l → connectors: l
- shedy: tokens: sh e p → vowel_run: e (level 1; class e)
- chokchey: tokens: ch o k ch e → vowel_run: e (level 1; class e)
...
- qokeey: tokens: qo k ee → vowel_run: ee (level 2; class e)
- checthey: tokens: ch e cth e → vowel_run: e (level 1; class e)
- oteedy: tokens: o t ee p → vowel_run: ee (level 2; class e)
- lchedy: tokens: l ch e p → connectors: l → vowel_run: e (level 1; class e)
...
- qokeey: tokens: qo k ee → vowel_run: ee (level 2; class e)
- qokedy: tokens: qo k e p → vowel_run: e (level 1; class e)
- chckhhy: tokens: ch ckh h → unmodeled_tokens: h
...
Direct Gloss (Procedural, Not a Real Translation):
- ycheeodain: tokens: ch ee o p a i n → connectors: n → vowel_run: ee (level 2; class e)
- okeeo: tokens: o k ee o → vowel_run: ee (level 2; class e)
- olchedy: tokens: o l ch e p → connectors: l → vowel_run: e (level 1; class e)
- lchedy: tokens: l ch e p → connectors: l → vowel_run: e (level 1; class e)
- qokeey: tokens: qo k ee → vowel_run: ee (level 2; class e)
- okeeedy: tokens: o k eee p → vowel_run: eee (level 3; class e)
- okain: tokens: o k a i n → connectors: n → vowel_run: a (level 1; class a) (lexicon-context: `okain` → `acino`; a berry)
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- chedyteey: tokens: ch e p t ee → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- ykeedaiin: tokens: k ee p aiin → vowel_run: ee (level 2; class e) → suffix: aiin (lexicon-context: `daiin` → `piani`; plans (arrangements))
- shekain: tokens: sh e k a i n → connectors: n → vowel_run: e (level 1; class e)
- shedy: tokens: sh e p → vowel_run: e (level 1; class e)
- qokear: tokens: qo k e a r → connectors: r → vowel_run: e (level 1; class e)
- ochey: tokens: o ch e → vowel_run: e (level 1; class e)
- reeey: tokens: r eee → connectors: r → vowel_run: eee (level 3; class e)
- qokeey: tokens: qo k ee → vowel_run: ee (level 2; class e)
- olaiiin: tokens: o l a iii n → connectors: l n → vowel_run: a (level 1; class a) → suffix: iin
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- lkeeody: tokens: l k ee o p → connectors: l → vowel_run: ee (level 2; class e)
...
- shkaiin: tokens: sh k aiin → vowel_run: a (level 1; class a) → suffix: aiin (lexicon-context: `kaiin` → `acini`; [n/a])
...
Direct Gloss (Procedural, Not a Real Translation):
- dsheeo: tokens: p sh ee o → vowel_run: ee (level 2; class e)
- qokeedy: tokens: qo k ee p → vowel_run: ee (level 2; class e)
- otchedey: tokens: o t ch e p e → vowel_run: e (level 1; class e)
- lshey: tokens: l sh e → connectors: l → vowel_run: e (level 1; class e)
- lkeedy: tokens: l k ee p → connectors: l → vowel_run: ee (level 2; class e)
- oteey: tokens: o t ee → vowel_run: ee (level 2; class e)
- qokeedy: tokens: qo k ee p → vowel_run: ee (level 2; class e)
- oteolair: tokens: o t e o l a i r → connectors: l r → vowel_run: e (level 1; class e)
- ar: tokens: a r → connectors: r → vowel_run: a (level 1; class a)
- shedam: tokens: sh e p a m → connectors: m → vowel_run: e (level 1; class e)
- cheam: tokens: ch e a m → connectors: m → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- qosheo: tokens: qo sh e o → vowel_run: e (level 1; class e)
- lchdy: tokens: l ch p → connectors: l
- lshedy: tokens: l sh e p → connectors: l → vowel_run: e (level 1; class e)
- olkeeedy: tokens: o l k eee p → connectors: l → vowel_run: eee (level 3; class e)
...
- cheodaiin: tokens: ch e o p aiin → vowel_run: e (level 1; class e) → suffix: aiin (lexicon-context: `odaiin` → `inopia`; poverty)
...
Direct Gloss (Procedural, Not a Real Translation):
- dchedar: tokens: p ch e p a r → connectors: r → vowel_run: e (level 1; class e) (lexicon-context: `chedar` → `capre`; [n/a])
- oteey: tokens: o t ee → vowel_run: ee (level 2; class e)
- lchey: tokens: l ch e → connectors: l → vowel_run: e (level 1; class e)
- ykeeeos: tokens: k eee o s → connectors: s → vowel_run: eee (level 3; class e)
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
- shear: tokens: sh e a r → connectors: r → vowel_run: e (level 1; class e)
- oteedy: tokens: o t ee p → vowel_run: ee (level 2; class e)
- tedam: tokens: t e p a m → connectors: m → vowel_run: e (level 1; class e)
- oteey: tokens: o t ee → vowel_run: ee (level 2; class e)
- pchedey: tokens: p ch e p e → vowel_run: e (level 1; class e)
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- lchedy: tokens: l ch e p → connectors: l → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- sheeodar: tokens: sh ee o p a r → connectors: r → vowel_run: ee (level 2; class e)
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
...
- pchdam: tokens: p ch p a m → connectors: m → vowel_run: a (level 1; class a)
...
Direct Gloss (Procedural, Not a Real Translation):
- dchedshey: tokens: p ch e p sh e → vowel_run: e (level 1; class e)
- qokeedy: tokens: qo k ee p → vowel_run: ee (level 2; class e)
- okeodain: tokens: o k e o p a i n → connectors: n → vowel_run: e (level 1; class e)
- shet: tokens: sh e t → vowel_run: e (level 1; class e)
- sheota: tokens: sh e o t a → vowel_run: e (level 1; class e)
- im: tokens: i m → connectors: m → vowel_run: i (level 1; class i)
- oteal: tokens: o t e a l → connectors: l → vowel_run: e (level 1; class e)
- tey: tokens: t e → vowel_run: e (level 1; class e)
- lkeey: tokens: l k ee → connectors: l → vowel_run: ee (level 2; class e)
- sheedy: tokens: sh ee p → vowel_run: ee (level 2; class e)
- shtar: tokens: sh t a r → connectors: r → vowel_run: a (level 1; class a)
- keedy: tokens: k ee p → vowel_run: ee (level 2; class e)
...
- chekeedy: tokens: ch e k ee p → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- daiin: tokens: p aiin → vowel_run: a (level 1; class a) → suffix: aiin (lexicon-context: `daiin` → `piani`; plans (arrangements))
- shecthey: tokens: sh e cth e → vowel_run: e (level 1; class e)
- oteody: tokens: o t e o p → vowel_run: e (level 1; class e)
- qochey: tokens: qo ch e → vowel_run: e (level 1; class e)
- qokeey: tokens: qo k ee → vowel_run: ee (level 2; class e)
- chey: tokens: ch e → vowel_run: e (level 1; class e)
- teey: tokens: t ee → vowel_run: ee (level 2; class e)
- qokeedy: tokens: qo k ee p → vowel_run: ee (level 2; class e)
...
- lokeedy: tokens: l o k ee p → connectors: l → vowel_run: ee (level 2; class e)
...
- qokeedy: tokens: qo k ee p → vowel_run: ee (level 2; class e)
- lchey: tokens: l ch e → connectors: l → vowel_run: e (level 1; class e)
- lcheoekam: tokens: l ch e o e k a m → connectors: l m → vowel_run: e (level 1; class e)
- oaiin: tokens: o aiin → vowel_run: a (level 1; class a) → suffix: aiin
- cheky: tokens: ch e k → vowel_run: e (level 1; class e)
- qokeeodar: tokens: qo k ee o p a r → connectors: r → vowel_run: ee (level 2; class e)
- checthdy: tokens: ch e cth p → vowel_run: e (level 1; class e)
- qoted: tokens: qo t e p → vowel_run: e (level 1; class e)
- l: tokens: l → connectors: l
- loty: tokens: l o t → connectors: l
...
- chedey: tokens: ch e p e → vowel_run: e (level 1; class e)
- cheol: tokens: ch e o l → connectors: l → vowel_run: e (level 1; class e)
- teedy: tokens: t ee p → vowel_run: ee (level 2; class e)
...
- ol: tokens: o l → connectors: l
- l: tokens: l → connectors: l
- kai: tokens: k a i → vowel_run: a (level 1; class a)
...
- al: tokens: a l → connectors: l → vowel_run: a (level 1; class a)
- l: tokens: l → connectors: l
- cheotydy: tokens: ch e o t p → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- ssheo: tokens: s sh e o → connectors: s → vowel_run: e (level 1; class e)
- l: tokens: l → connectors: l
- keedy: tokens: k ee p → vowel_run: ee (level 2; class e)
- dal: tokens: p a l → connectors: l → vowel_run: a (level 1; class a)
...
- qokeshey: tokens: qo k e sh e → vowel_run: e (level 1; class e)
- keeshody: tokens: k ee sh o p → vowel_run: ee (level 2; class e)
- qokeey: tokens: qo k ee → vowel_run: ee (level 2; class e)
- qokedy: tokens: qo k e p → vowel_run: e (level 1; class e)
- okain: tokens: o k a i n → connectors: n → vowel_run: a (level 1; class a) (lexicon-context: `okain` → `acino`; a berry)
- shekal: tokens: sh e k a l → connectors: l → vowel_run: e (level 1; class e)
- okechedy: tokens: o k e ch e p → vowel_run: e (level 1; class e)
...
- lchal: tokens: l ch a l → connectors: l l → vowel_run: a (level 1; class a)
- lkechey: tokens: l k e ch e → connectors: l → vowel_run: e (level 1; class e)
- okeey: tokens: o k ee → vowel_run: ee (level 2; class e)
- lkechedy: tokens: l k e ch e p → connectors: l → vowel_run: e (level 1; class e)
...
- lchr: tokens: l ch r → connectors: l r
- ainai: tokens: a i n a i → connectors: n → vowel_run: a (level 1; class a)
...
- oxar: tokens: o x a r → connectors: r → vowel_run: a (level 1; class a)
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
...
Direct Gloss (Procedural, Not a Real Translation):
- soaiin: tokens: s o aiin → connectors: s → vowel_run: a (level 1; class a) → suffix: aiin
- shecthy: tokens: sh e cth → vowel_run: e (level 1; class e)
- oteodaiin: tokens: o t e o p aiin → vowel_run: e (level 1; class e) → suffix: aiin (lexicon-context: `odaiin` → `inopia`; poverty)
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- otedar: tokens: o t e p a r → connectors: r → vowel_run: e (level 1; class e)
...
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- qokeedy: tokens: qo k ee p → vowel_run: ee (level 2; class e)
- qoteedaiin: tokens: qo t ee p aiin → vowel_run: ee (level 2; class e) → suffix: aiin (lexicon-context: `daiin` → `piani`; plans (arrangements))
...
- daiin: tokens: p aiin → vowel_run: a (level 1; class a) → suffix: aiin (lexicon-context: `daiin` → `piani`; plans (arrangements))
- chedar: tokens: ch e p a r → connectors: r → vowel_run: e (level 1; class e) (lexicon-context: `chedar` → `capre`; [n/a])
- chedyteedain: tokens: ch e p t ee p a i n → connectors: n → vowel_run: e (level 1; class e)
...
- sheokar: tokens: sh e o k a r → connectors: r → vowel_run: e (level 1; class e)
- shekeey: tokens: sh e k ee → vowel_run: e (level 1; class e)
- qotees: tokens: qo t ee s → connectors: s → vowel_run: ee (level 2; class e)
- al: tokens: a l → connectors: l → vowel_run: a (level 1; class a)
- dain: tokens: p a i n → connectors: n → vowel_run: a (level 1; class a)
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- salkeedy: tokens: s a l k ee p → connectors: s l → vowel_run: a (level 1; class a)
- lkeedy: tokens: l k ee p → connectors: l → vowel_run: ee (level 2; class e)
- chckhy: tokens: ch ckh
- rky: tokens: r k → connectors: r
- chey: tokens: ch e → vowel_run: e (level 1; class e)
- okeeo: tokens: o k ee o → vowel_run: ee (level 2; class e)
- chr: tokens: ch r → connectors: r
- al: tokens: a l → connectors: l → vowel_run: a (level 1; class a)
...
- q: tokens: q
- o: tokens: o
- irain: tokens: i r a i n → connectors: r n → vowel_run: i (level 1; class i)
...
Direct Gloss (Procedural, Not a Real Translation):
- sheotchedy: tokens: sh e o t ch e p → vowel_run: e (level 1; class e)
- shedain: tokens: sh e p a i n → connectors: n → vowel_run: e (level 1; class e)
- shkeyqokeaiin: tokens: sh k e qo k e aiin → vowel_run: e (level 1; class e) → suffix: aiin
- shkeody: tokens: sh k e o p → vowel_run: e (level 1; class e)
- qokeey: tokens: qo k ee → vowel_run: ee (level 2; class e)
- qokeedy: tokens: qo k ee p → vowel_run: ee (level 2; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- dsheeoteey: tokens: p sh ee o t ee → vowel_run: ee (level 2; class e)
- qokeeo: tokens: qo k ee o → vowel_run: ee (level 2; class e)
- l: tokens: l → connectors: l
- keey: tokens: k ee → vowel_run: ee (level 2; class e)
- tear: tokens: t e a r → connectors: r → vowel_run: e (level 1; class e)
- qoteey: tokens: qo t ee → vowel_run: ee (level 2; class e)
- qotain: tokens: qo t a i n → connectors: n → vowel_run: a (level 1; class a) (lexicon-context: `qotain` → `antico`; ancient)
- cho: tokens: ch o
- lkeeedy: tokens: l k eee p → connectors: l → vowel_run: eee (level 3; class e)
- lchechdy: tokens: l ch e ch p → connectors: l → vowel_run: e (level 1; class e)
- qokechy: tokens: qo k e ch → vowel_run: e (level 1; class e)
...
- ol: tokens: o l → connectors: l
- keey: tokens: k ee → vowel_run: ee (level 2; class e)
- lkair: tokens: l k a i r → connectors: l r → vowel_run: a (level 1; class a)
- cheda: tokens: ch e p a → vowel_run: e (level 1; class e)
- chkal: tokens: ch k a l → connectors: l → vowel_run: a (level 1; class a)
- keeodal: tokens: k ee o p a l → connectors: l → vowel_run: ee (level 2; class e)
...
- ar: tokens: a r → connectors: r → vowel_run: a (level 1; class a)
- akeom: tokens: a k e o m → connectors: m → vowel_run: a (level 1; class a)
- qokain: tokens: qo k a i n → connectors: n → vowel_run: a (level 1; class a) (lexicon-context: `qokain` → `acconi`; [n/a])
- al: tokens: a l → connectors: l → vowel_run: a (level 1; class a)
- qokeeod: tokens: qo k ee o p → vowel_run: ee (level 2; class e)
- lkedlkey: tokens: l k e p l k e → connectors: l l → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- y: [unparsed]
- chedl: tokens: ch e p l → connectors: l → vowel_run: e (level 1; class e)
- ar: tokens: a r → connectors: r → vowel_run: a (level 1; class a)
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
- aiy: tokens: a i → vowel_run: a (level 1; class a)
...
Direct Gloss (Procedural, Not a Real Translation):
- polal: tokens: p o l a l → connectors: l l → vowel_run: a (level 1; class a)
...
- pykeor: tokens: p k e o r → connectors: r → vowel_run: e (level 1; class e)
- cheefy: tokens: ch ee f → vowel_run: ee (level 2; class e)
- qopchey: tokens: qo p ch e → vowel_run: e (level 1; class e)
- opchedal: tokens: o p ch e p a l → connectors: l → vowel_run: e (level 1; class e)
- lfchedy: tokens: l f ch e p → connectors: l → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- dched: tokens: p ch e p → vowel_run: e (level 1; class e)
- daiin: tokens: p aiin → vowel_run: a (level 1; class a) → suffix: aiin (lexicon-context: `daiin` → `piani`; plans (arrangements))
- al: tokens: a l → connectors: l → vowel_run: a (level 1; class a)
- okeey: tokens: o k ee → vowel_run: ee (level 2; class e)
...
- l: tokens: l → connectors: l
- ltain: tokens: l t a i n → connectors: l n → vowel_run: a (level 1; class a)
...
- okain: tokens: o k a i n → connectors: n → vowel_run: a (level 1; class a) (lexicon-context: `okain` → `acino`; a berry)
- oteain: tokens: o t e a i n → connectors: n → vowel_run: e (level 1; class e)
- shok: tokens: sh o k
- qokechdy: tokens: qo k e ch p → vowel_run: e (level 1; class e)
- okechedy: tokens: o k e ch e p → vowel_run: e (level 1; class e)
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- qokeey: tokens: qo k ee → vowel_run: ee (level 2; class e)
- cheamar: tokens: ch e a m a r → connectors: m r → vowel_run: e (level 1; class e)
...
- otedy: tokens: o t e p → vowel_run: e (level 1; class e)
- qokeokedy: tokens: qo k e o k e p → vowel_run: e (level 1; class e)
- qokeedy: tokens: qo k ee p → vowel_run: ee (level 2; class e)
- oteeolkeey: tokens: o t ee o l k ee → connectors: l → vowel_run: ee (level 2; class e)
- okeeo: tokens: o k ee o → vowel_run: ee (level 2; class e)
- l: tokens: l → connectors: l
- lainal: tokens: l a i n a l → connectors: l n l → vowel_run: a (level 1; class a)
...
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- chedyteokain: tokens: ch e p t e o k a i n → connectors: n → vowel_run: e (level 1; class e) (lexicon-context: `okain` → `acino`; a berry)
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- l: tokens: l → connectors: l
- kag: tokens: k a g → vowel_run: a (level 1; class a)
- am: tokens: a m → connectors: m → vowel_run: a (level 1; class a)
...
- okeedy: tokens: o k ee p → vowel_run: ee (level 2; class e)
- lkeedy: tokens: l k ee p → connectors: l → vowel_run: ee (level 2; class e)
- lkedar: tokens: l k e p a r → connectors: l r → vowel_run: e (level 1; class e)
- okeedy: tokens: o k ee p → vowel_run: ee (level 2; class e)
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- pchedar: tokens: p ch e p a r → connectors: r → vowel_run: e (level 1; class e) (lexicon-context: `chedar` → `capre`; [n/a])
- oteeol: tokens: o t ee o l → connectors: l → vowel_run: ee (level 2; class e)
- lkeedain: tokens: l k ee p a i n → connectors: l n → vowel_run: ee (level 2; class e)
- okeam: tokens: o k e a m → connectors: m → vowel_run: e (level 1; class e)
- sheo: tokens: sh e o → vowel_run: e (level 1; class e)
- teolkedain: tokens: t e o l k e p a i n → connectors: l n → vowel_run: e (level 1; class e)
- shal: tokens: sh a l → connectors: l → vowel_run: a (level 1; class a)
- keey: tokens: k ee → vowel_run: ee (level 2; class e)
- lteeal: tokens: l t ee a l → connectors: l l → vowel_run: ee (level 2; class e)
...
- teed: tokens: t ee p → vowel_run: ee (level 2; class e)
...
- oteed: tokens: o t ee p → vowel_run: ee (level 2; class e)
- lkeedy: tokens: l k ee p → connectors: l → vowel_run: ee (level 2; class e)
- okeeshey: tokens: o k ee sh e → vowel_run: ee (level 2; class e)
- chey: tokens: ch e → vowel_run: e (level 1; class e)
- lkar: tokens: l k a r → connectors: l r → vowel_run: a (level 1; class a)
- al: tokens: a l → connectors: l → vowel_run: a (level 1; class a)
- olchal: tokens: o l ch a l → connectors: l l → vowel_run: a (level 1; class a)
- or: tokens: o r → connectors: r
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
...
- sheey: tokens: sh ee → vowel_run: ee (level 2; class e)
- qoteedy: tokens: qo t ee p → vowel_run: ee (level 2; class e)
- qeear: tokens: q ee a r → connectors: r → vowel_run: ee (level 2; class e)
- al: tokens: a l → connectors: l → vowel_run: a (level 1; class a)
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- okeey: tokens: o k ee → vowel_run: ee (level 2; class e)
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- poeokeey: tokens: p o e o k ee → vowel_run: e (level 1; class e)
- lkeedy: tokens: l k ee p → connectors: l → vowel_run: ee (level 2; class e)
- tedain: tokens: t e p a i n → connectors: n → vowel_run: e (level 1; class e)
- shecthy: tokens: sh e cth → vowel_run: e (level 1; class e)
- qokeedy: tokens: qo k ee p → vowel_run: ee (level 2; class e)
- chckhy: tokens: ch ckh
- lfchy: tokens: l f ch → connectors: l
- cheal: tokens: ch e a l → connectors: l → vowel_run: e (level 1; class e)
- chepcham: tokens: ch e p ch a m → connectors: m → vowel_run: e (level 1; class e)
...
- qokeey: tokens: qo k ee → vowel_run: ee (level 2; class e)
- lchedy: tokens: l ch e p → connectors: l → vowel_run: e (level 1; class e)
- keeor: tokens: k ee o r → connectors: r → vowel_run: ee (level 2; class e)
- okeey: tokens: o k ee → vowel_run: ee (level 2; class e)
- lkeedy: tokens: l k ee p → connectors: l → vowel_run: ee (level 2; class e)
- lkeey: tokens: l k ee → connectors: l → vowel_run: ee (level 2; class e)
...
- l: tokens: l → connectors: l
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- cheekain: tokens: ch ee k a i n → connectors: n → vowel_run: ee (level 2; class e)
- qokeeokain: tokens: qo k ee o k a i n → connectors: n → vowel_run: ee (level 2; class e) (lexicon-context: `okain` → `acino`; a berry)
- chckhy: tokens: ch ckh
- cheal: tokens: ch e a l → connectors: l → vowel_run: e (level 1; class e)
- k: tokens: k
- ee: tokens: ee → vowel_run: ee (level 2; class e)
...
- lkal: tokens: l k a l → connectors: l l → vowel_run: a (level 1; class a)
...
Direct Gloss (Procedural, Not a Real Translation):
- polkeeo: tokens: p o l k ee o → connectors: l → vowel_run: ee (level 2; class e)
- shey: tokens: sh e → vowel_run: e (level 1; class e)
- cheokeain: tokens: ch e o k e a i n → connectors: n → vowel_run: e (level 1; class e)
- chl: tokens: ch l → connectors: l
...
- qokeain: tokens: qo k e a i n → connectors: n → vowel_run: e (level 1; class e)
- shckhy: tokens: sh ckh
- sain: tokens: s a i n → connectors: s n → vowel_run: a (level 1; class a)
- chckhy: tokens: ch ckh
- char: tokens: ch a r → connectors: r → vowel_run: a (level 1; class a)
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
- alom: tokens: a l o m → connectors: l m → vowel_run: a (level 1; class a)
...
Direct Gloss (Procedural, Not a Real Translation):
- yshe: tokens: sh e → vowel_run: e (level 1; class e)
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
- okshdy: tokens: o k sh p
- shkeey: tokens: sh k ee → vowel_run: ee (level 2; class e)
- kain: tokens: k a i n → connectors: n → vowel_run: a (level 1; class a)
- chaiin: tokens: ch aiin → vowel_run: a (level 1; class a) → suffix: aiin
- alolshey: tokens: a l o l sh e → connectors: l l → vowel_run: a (level 1; class a)
- qokaiin: tokens: qo k aiin → vowel_run: a (level 1; class a) → suffix: aiin (lexicon-context: `qokaiin` → `ciancio`; [n/a])
- chcthydain: tokens: ch cth p a i n → connectors: n → vowel_run: a (level 1; class a)
...
- chckhaiin: tokens: ch ckh aiin → vowel_run: a (level 1; class a) → suffix: aiin
- dair: tokens: p a i r → connectors: r → vowel_run: a (level 1; class a)
- qokal: tokens: qo k a l → connectors: l → vowel_run: a (level 1; class a) (lexicon-context: `qokal` → `calco`; cast (of sculpture))
- otain: tokens: o t a i n → connectors: n → vowel_run: a (level 1; class a) (lexicon-context: `otain` → `anito`; [n/a])
