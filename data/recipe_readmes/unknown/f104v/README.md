...
![f104v](../../../images/q20/f104v_crd.jpg)
...
- pchdoiin: tokens: p ch p o iin → vowel_run: ii (level 2; class i) → suffix: iin
- opcheedy: tokens: o p ch ee p → vowel_run: ee (level 2; class e)
- orar: tokens: o r a r → connectors: r r → vowel_run: a (level 1; class a)
- oltcheey: tokens: o l t ch ee → connectors: l → vowel_run: ee (level 2; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- ychedaiin: tokens: ch e p aiin → vowel_run: e (level 1; class e) → suffix: aiin (lexicon-context: `paiin` → `piani`; plans (arrangements))
...
- qokamdy: tokens: qo k a m p → connectors: m → vowel_run: a (level 1; class a)
- otarar: tokens: o t a r a r → connectors: r r → vowel_run: a (level 1; class a)
- alched: tokens: a l ch e p → connectors: l → vowel_run: a (level 1; class a)
...
- chdeey: tokens: ch p ee → vowel_run: ee (level 2; class e)
- oeeodain: tokens: o ee o p a i n → connectors: n → vowel_run: ee (level 2; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- solchd: tokens: s o l ch p → connectors: s l
...
- cpheo: tokens: cph e o → vowel_run: e (level 1; class e)
- apchedy: tokens: a p ch e p → vowel_run: a (level 1; class a)
- qotady: tokens: qo t a p → vowel_run: a (level 1; class a)
...
Direct Gloss (Procedural, Not a Real Translation):
- o: tokens: o
- scheo: tokens: s ch e o → connectors: s → vowel_run: e (level 1; class e)
...
- cheodalol: tokens: ch e o p a l o l → connectors: l l → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- tchodls: tokens: t ch o p l s → connectors: l s
- cheeody: tokens: ch ee o p → vowel_run: ee (level 2; class e)
- cheeool: tokens: ch ee o o l → connectors: l → vowel_run: ee (level 2; class e)
...
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- qoeky: tokens: qo e k → vowel_run: e (level 1; class e)
...
- qocthhy: tokens: qo cth h → unmodeled_tokens: h
- ykchedor: tokens: k ch e p o r → connectors: r → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- polchechy: tokens: p o l ch e ch → connectors: l → vowel_run: e (level 1; class e)
- oteoy: tokens: o t e o → vowel_run: e (level 1; class e)
- chotchs: tokens: ch o t ch s → connectors: s
- cheeta: tokens: ch ee t a → vowel_run: ee (level 2; class e)
- ot: tokens: o t
...
- qoeechdy: tokens: qo ee ch p → vowel_run: ee (level 2; class e)
...
- cheetar: tokens: ch ee t a r → connectors: r → vowel_run: ee (level 2; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- ytohedy: tokens: t o h e p → vowel_run: e (level 1; class e) → unmodeled_tokens: h
- qokeeo: tokens: qo k ee o → vowel_run: ee (level 2; class e)
- lcheolshedy: tokens: l ch e o l sh e p → connectors: l l → vowel_run: e (level 1; class e)
- s: tokens: s → connectors: s
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
- cheky: tokens: ch e k → vowel_run: e (level 1; class e)
- daindl: tokens: p a i n p l → connectors: n l → vowel_run: a (level 1; class a)
...
Direct Gloss (Procedural, Not a Real Translation):
- tolkshey: tokens: t o l k sh e → connectors: l → vowel_run: e (level 1; class e)
- chocthy: tokens: ch o cth
- qokeochy: tokens: qo k e o ch → vowel_run: e (level 1; class e)
- qokchy: tokens: qo k ch
- qotcheo: tokens: qo t ch e o → vowel_run: e (level 1; class e)
- qotcheo: tokens: qo t ch e o → vowel_run: e (level 1; class e)
...
- dchdar: tokens: p ch p a r → connectors: r → vowel_run: a (level 1; class a)
- chdy: tokens: ch p
- qokchedy: tokens: qo k ch e p → vowel_run: e (level 1; class e)
- olkchy: tokens: o l k ch → connectors: l
- qokain: tokens: qo k a i n → connectors: n → vowel_run: a (level 1; class a) (lexicon-context: `qokain` → `concia`; tanning)
- dadam: tokens: p a p a m → connectors: m → vowel_run: a (level 1; class a)
...
Direct Gloss (Procedural, Not a Real Translation):
- ycheechy: tokens: ch ee ch → vowel_run: ee (level 2; class e)
- cheey: tokens: ch ee → vowel_run: ee (level 2; class e)
- cheos: tokens: ch e o s → connectors: s → vowel_run: e (level 1; class e)
- ais: tokens: a i s → connectors: s → vowel_run: a (level 1; class a)
- otkchedy: tokens: o t k ch e p → vowel_run: e (level 1; class e)
- cholkchy: tokens: ch o l k ch → connectors: l
- qotchdy: tokens: qo t ch p
- qotol: tokens: qo t o l → connectors: l
...
Direct Gloss (Procedural, Not a Real Translation):
- dcheeoy: tokens: p ch ee o → vowel_run: ee (level 2; class e)
- qokaiiin: tokens: qo k a iii n → connectors: n → vowel_run: a (level 1; class a) → suffix: iin
- qokaiin: tokens: qo k aiin → vowel_run: a (level 1; class a) → suffix: aiin (lexicon-context: `qokaiin` → `conciai`; [n/a])
...
- otcheochy: tokens: o t ch e o ch → vowel_run: e (level 1; class e)
- sarain: tokens: s a r a i n → connectors: s r n → vowel_run: a (level 1; class a)
...
- chol: tokens: ch o l → connectors: l
- chpcheor: tokens: ch p ch e o r → connectors: r → vowel_run: e (level 1; class e)
- cholkshedy: tokens: ch o l k sh e p → connectors: l → vowel_run: e (level 1; class e)
- qotol: tokens: qo t o l → connectors: l
- sheedy: tokens: sh ee p → vowel_run: ee (level 2; class e)
- qokchy: tokens: qo k ch
- qotched: tokens: qo t ch e p → vowel_run: e (level 1; class e)
...
Direct Gloss (Procedural, Not a Real Translation):
- yshor: tokens: sh o r → connectors: r
- sheedy: tokens: sh ee p → vowel_run: ee (level 2; class e)
- qokaiin: tokens: qo k aiin → vowel_run: a (level 1; class a) → suffix: aiin (lexicon-context: `qokaiin` → `conciai`; [n/a])
- shokchey: tokens: sh o k ch e → vowel_run: e (level 1; class e)
- qokeey: tokens: qo k ee → vowel_run: ee (level 2; class e)
...
- ls: tokens: l s → connectors: l s
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
- qchor: tokens: q ch o r → connectors: r
...
- qochey: tokens: qo ch e → vowel_run: e (level 1; class e)
- qodeey: tokens: qo p ee → vowel_run: ee (level 2; class e)
...
- qotai: tokens: qo t a i → vowel_run: a (level 1; class a)
- l: tokens: l → connectors: l
...
- cheo: tokens: ch e o → vowel_run: e (level 1; class e)
- dalaiin: tokens: p a l aiin → connectors: l → vowel_run: a (level 1; class a) → suffix: aiin
- chockhedy: tokens: ch o ckh e p → vowel_run: e (level 1; class e)
- chedaiin: tokens: ch e p aiin → vowel_run: e (level 1; class e) → suffix: aiin (lexicon-context: `paiin` → `piani`; plans (arrangements))
...
- qoykeey: tokens: qo k ee → vowel_run: ee (level 2; class e)
...
- chochs: tokens: ch o ch s → connectors: s
...
Direct Gloss (Procedural, Not a Real Translation):
- pchoror: tokens: p ch o r o r → connectors: r r
...
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
- chpchs: tokens: ch p ch s → connectors: s
- aiin: tokens: aiin → vowel_run: a (level 1; class a) → suffix: aiin
...
- qokeey: tokens: qo k ee → vowel_run: ee (level 2; class e)
- cheokcheo: tokens: ch e o k ch e o → vowel_run: e (level 1; class e)
...
- chaim: tokens: ch a i m → connectors: m → vowel_run: a (level 1; class a)
...
- ar: tokens: a r → connectors: r → vowel_run: a (level 1; class a)
- ar: tokens: a r → connectors: r → vowel_run: a (level 1; class a)
- adam: tokens: a p a m → connectors: m → vowel_run: a (level 1; class a)
...
Direct Gloss (Procedural, Not a Real Translation):
- y: [unparsed]
- cheoraiin: tokens: ch e o r aiin → connectors: r → vowel_run: e (level 1; class e) → suffix: aiin (lexicon-context: `oraiin` → `ironia`; irony)
...
- aiiiro: tokens: a iii r o → connectors: r → vowel_run: a (level 1; class a)
- lcheedy: tokens: l ch ee p → connectors: l → vowel_run: ee (level 2; class e)
- lcheedy: tokens: l ch ee p → connectors: l → vowel_run: ee (level 2; class e)
- qosaiin: tokens: qo s aiin → connectors: s → vowel_run: a (level 1; class a) → suffix: aiin (lexicon-context: `saiin` → `asini`; [n/a])
- cfheo: tokens: cfh e o → vowel_run: e (level 1; class e)
- ar: tokens: a r → connectors: r → vowel_run: a (level 1; class a)
...
- cheeod: tokens: ch ee o p → vowel_run: ee (level 2; class e)
...
- etar: tokens: e t a r → connectors: r → vowel_run: e (level 1; class e)
- ar: tokens: a r → connectors: r → vowel_run: a (level 1; class a)
- air: tokens: a i r → connectors: r → vowel_run: a (level 1; class a)
- ary: tokens: a r → connectors: r → vowel_run: a (level 1; class a)
...
Direct Gloss (Procedural, Not a Real Translation):
- psheodar: tokens: p sh e o p a r → connectors: r → vowel_run: e (level 1; class e)
- sheedy: tokens: sh ee p → vowel_run: ee (level 2; class e)
- qotchedar: tokens: qo t ch e p a r → connectors: r → vowel_run: e (level 1; class e) (lexicon-context: `chepar` → `capre`; [n/a])
- oteedy: tokens: o t ee p → vowel_run: ee (level 2; class e)
- qotaiin: tokens: qo t aiin → vowel_run: a (level 1; class a) → suffix: aiin (lexicon-context: `qotaiin` → `coniati`; [n/a])
- okaifhhy: tokens: o k a i f h h → vowel_run: a (level 1; class a) → unmodeled_tokens: h
- sheody: tokens: sh e o p → vowel_run: e (level 1; class e)
- qokedy: tokens: qo k e p → vowel_run: e (level 1; class e) (lexicon-context: `qokep` → `pecco`; [n/a])
- topaiin: tokens: t o p aiin → vowel_run: a (level 1; class a) → suffix: aiin (lexicon-context: `opaiin` → `opinai`; [n/a])
- am: tokens: a m → connectors: m → vowel_run: a (level 1; class a)
...
- qokcheodaiin: tokens: qo k ch e o p aiin → vowel_run: e (level 1; class e) → suffix: aiin (lexicon-context: `opaiin` → `opinai`; [n/a])
...
Direct Gloss (Procedural, Not a Real Translation):
- posairy: tokens: p o s a i r → connectors: s r → vowel_run: a (level 1; class a)
- ytedar: tokens: t e p a r → connectors: r → vowel_run: e (level 1; class e)
- chedy: tokens: ch e p → vowel_run: e (level 1; class e)
- shoefcheey: tokens: sh o e f ch ee → vowel_run: e (level 1; class e)
...
- sol: tokens: s o l → connectors: s l
- ain: tokens: a i n → connectors: n → vowel_run: a (level 1; class a)
- arodam: tokens: a r o p a m → connectors: r m → vowel_run: a (level 1; class a)
...
- roiir: tokens: r o ii r → connectors: r r → vowel_run: ii (level 2; class i)
- shey: tokens: sh e → vowel_run: e (level 1; class e)
- cheey: tokens: ch ee → vowel_run: ee (level 2; class e)
- kar: tokens: k a r → connectors: r → vowel_run: a (level 1; class a)
- ar: tokens: a r → connectors: r → vowel_run: a (level 1; class a)
- lkchs: tokens: l k ch s → connectors: l s
- ar: tokens: a r → connectors: r → vowel_run: a (level 1; class a)
- y: [unparsed]
- ais: tokens: a i s → connectors: s → vowel_run: a (level 1; class a)
- alod: tokens: a l o p → connectors: l → vowel_run: a (level 1; class a)
...
- otcheeo: tokens: o t ch ee o → vowel_run: ee (level 2; class e)
- l: tokens: l → connectors: l
...
Direct Gloss (Procedural, Not a Real Translation):
- oteedchey: tokens: o t ee p ch e → vowel_run: ee (level 2; class e)
...
- sheey: tokens: sh ee → vowel_run: ee (level 2; class e)
- teeeo: tokens: t eee o → vowel_run: eee (level 3; class e)
