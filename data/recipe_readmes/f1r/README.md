# Voynich Speculative Herbal Ferment Recipe — f1r
...
- compound_counts: {'aroma modifier': 2, 'main herb': 43, 'sugars': 40, 'heat': 21, 'secondary herb': 43, 'mix/transfer': 121, 'complex herbal compound': 36, 'yeast fermentation': 64}
- dose_level: 2
...
- fachys: add main plant (safe substitute) → add aroma modifier → duration level 1 → state: fermentation start
- ykal: add fermentable sugars → duration level 1 → state: fermentation start
- ar: duration level 1 → state: fermentation start
- ataiin: apply heat/cooking → duration level 1 → state: fermentation start → long fermentation / aging phase
...
- ase: duration level 1 → state: fermentation start
...
Direct Gloss (Procedural, Not a Real Translation):
- syaiir: duration level 1 → state: fermentation start
...
- cthoary: mix / transfer → add complex herbal compound (safe blend) → duration level 1 → state: fermentation start
- cthes: add complex herbal compound (safe blend) → duration level 1 → state: active extraction
- daraiin: start fermentation (yeast) → duration level 1 → state: fermentation start → long fermentation / aging phase
- sy: [unparsed]
...
Direct Gloss (Procedural, Not a Real Translation):
- ydaraishy: add secondary herb (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- oydar: mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
- sh: add secondary herb (safe substitute)
- s: [unparsed]
- cfhoaiin: mix / transfer → add complex herbal compound (safe blend) → duration level 1 → state: fermentation start → long fermentation / aging phase
- shodary: add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- cphesaiin: add complex herbal compound (safe blend) → duration level 1 → state: active extraction → long fermentation / aging phase
- ols: mix / transfer
...
- otairin: apply heat/cooking → mix / transfer → duration level 1 → state: fermentation start
...
- cphodaiils: mix / transfer → start fermentation (yeast) → add complex herbal compound (safe blend) → duration level 1 → state: fermentation start
- cthey: add complex herbal compound (safe blend) → duration level 1 → state: active extraction
- sho: add secondary herb (safe substitute) → mix / transfer
- oldain: mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- sho: add secondary herb (safe substitute) → mix / transfer
- chol: add main plant (safe substitute) → mix / transfer
- shodan: add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
...
- dydyd: start fermentation (yeast)
- cthy: add complex herbal compound (safe blend)
...
- kodshey: add fermentable sugars → add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
...
- dain: start fermentation (yeast) → duration level 1 → state: fermentation start
- ckhyds: start fermentation (yeast) → add complex herbal compound (safe blend)
...
- shcthaiin: add secondary herb (safe substitute) → add complex herbal compound (safe blend) → duration level 1 → state: fermentation start → long fermentation / aging phase
...
- dlocto: apply heat/cooking → mix / transfer → start fermentation (yeast)
...
- chol: add main plant (safe substitute) → mix / transfer
- tshodeesy: apply heat/cooking → add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 2 → state: active extraction
- shey: add secondary herb (safe substitute) → duration level 1 → state: active extraction
- pydeey: start fermentation (yeast) → duration level 2 → state: active extraction
...
Direct Gloss (Procedural, Not a Real Translation):
- ydoin: mix / transfer → start fermentation (yeast) → duration level 1 → state: cooling/rest
- chol: add main plant (safe substitute) → mix / transfer
- dain: start fermentation (yeast) → duration level 1 → state: fermentation start
...
- daiin: start fermentation (yeast) → duration level 1 → state: fermentation start → long fermentation / aging phase
- ctholdar: mix / transfer → start fermentation (yeast) → add complex herbal compound (safe blend) → duration level 1 → state: fermentation start
...
- kokaiin: add fermentable sugars → mix / transfer → duration level 1 → state: fermentation start → long fermentation / aging phase
- o: mix / transfer
- chol: add main plant (safe substitute) → mix / transfer
