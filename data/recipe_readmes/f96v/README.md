...
- compound_counts: {'yeast fermentation': 18, 'secondary herb': 6, 'mix/transfer': 42, 'liquid base': 2, 'complex herbal compound': 14, 'heat': 11, 'main herb': 14, 'sugars': 2}
- dose_level: 3
...
- psheessheeor: add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 2 → state: active extraction
- qoepsheody: prepare liquid base → add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
- odar: mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
- ocpheeo: mix / transfer → add complex herbal compound (safe blend) → duration level 2 → state: active extraction
- opar: mix / transfer → start fermentation (yeast) → duration level 1 → state: fermentation start
- ysar: duration level 1 → state: fermentation start
- osoj: mix / transfer
...
Direct Gloss (Procedural, Not a Real Translation):
- ytear: apply heat/cooking → duration level 1 → state: active extraction
...
- dteodoiin: apply heat/cooking → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction → medium fermentation phase
- saro: mix / transfer → duration level 1 → state: fermentation start
- qoches: prepare liquid base → add main plant (safe substitute) → duration level 1 → state: active extraction
- y: [unparsed]
...
Direct Gloss (Procedural, Not a Real Translation):
- dcheoteos: apply heat/cooking → add main plant (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
- cpheos: mix / transfer → add complex herbal compound (safe blend) → duration level 1 → state: active extraction
- sor: mix / transfer
- chcthory: add main plant (safe substitute) → mix / transfer → add complex herbal compound (safe blend)
...
Direct Gloss (Procedural, Not a Real Translation):
- dsheos: add secondary herb (safe substitute) → mix / transfer → start fermentation (yeast) → duration level 1 → state: active extraction
- sheey: add secondary herb (safe substitute) → duration level 2 → state: active extraction
- teocthey: apply heat/cooking → mix / transfer → add complex herbal compound (safe blend) → duration level 1 → state: active extraction
- cteeodody: apply heat/cooking → mix / transfer → start fermentation (yeast) → duration level 2 → state: active extraction
...
- ckheeody: mix / transfer → start fermentation (yeast) → add complex herbal compound (safe blend) → duration level 2 → state: active extraction
- ar: duration level 1 → state: fermentation start
- eeeykey: add fermentable sugars → duration level 3 → state: active extraction
...
- choraryctol: apply heat/cooking → add main plant (safe substitute) → mix / transfer → duration level 1 → state: fermentation start
...
- ckheal: add complex herbal compound (safe blend) → duration level 1 → state: active extraction
- daiins: start fermentation (yeast) → duration level 1 → state: fermentation start → long fermentation / aging phase
...
Direct Gloss (Procedural, Not a Real Translation):
- oeol: mix / transfer → duration level 1 → state: active extraction
- ckheor: mix / transfer → add complex herbal compound (safe blend) → duration level 1 → state: active extraction
...
- socthh: mix / transfer → add complex herbal compound (safe blend)
...
Direct Gloss (Procedural, Not a Real Translation):
- sosar: mix / transfer → duration level 1 → state: fermentation start
- cheekeo: add fermentable sugars → add main plant (safe substitute) → mix / transfer → duration level 2 → state: active extraction
...
Direct Gloss (Procedural, Not a Real Translation):
- soysar: mix / transfer → duration level 1 → state: fermentation start
