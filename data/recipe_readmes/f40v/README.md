# Voynich Speculative Herbal Ferment Recipe — f40v

IMPORTANT: this is NOT a real or validated translation of the Voynich Manuscript. It is a speculative/procedural model that interprets EVA using a user-defined grammar to generate experimental recipes using safe, known edible substitutes.

This file is generated automatically from IVTFF/EVA transliteration plus a user-defined procedural grammar.

![f40v](../../images/q05/f040v_crd.jpg)

## Page / Folio
- currier: B
- folio: f40v
- page_number: 78
- plant_candidates: ['Thistle', 'Gerneolem Artichoke', 'Helianthus Tuberosus']
- plant_category_confidence: 0.95
- plant_category_guess: root
- plant_category_matches: ['tuber']
- plant_id: Thistle, Gerneolem(?) Artichoke, Helianthus Tuberosus
- section: herbal
...
- compound_counts: {'yeast fermentation': 37, 'main herb': 28, 'aroma modifier': 5, 'mix/transfer': 44, 'heat': 11, 'liquid base': 16, 'sugars': 38, 'complex herbal compound': 4, 'secondary herb': 3}
- dose_level: 2
...
- chkalykedy: add fermentable sugars → add main plant (safe substitute) → start fermentation (yeast) → duration level 1 → state: fermentation start
...
Direct Gloss (Procedural, Not a Real Translation):
- tchkaiin: add fermentable sugars → apply heat/cooking → add main plant (safe substitute) → duration level 1 → state: fermentation start → long fermentation / aging phase
...
- faimy: add aroma modifier → duration level 1 → state: fermentation start
